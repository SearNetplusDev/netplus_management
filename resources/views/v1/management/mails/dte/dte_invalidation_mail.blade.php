...
<head>
    ...
    <title>Anulación de Documento Tributario Electrónico Emitido</title>
...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <span class="header-icon">
            ...
            <h1 class="header-title">Documento Tributario Electrónico Invalidado</h1>
        </div>
        ...
        <div class="email-body">
            ...
            <p class="greeting-text">
                Le informamos que hemos invalidado correctamente su <strong>Documento Tributario Electrónico
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $originalDte->control_number }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Código de Generación</span>
                    <span class="info-value">{{ $cancelDte->generation_code }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Sello de Recepción</span>
                    <span class="info-value">{{ $cancelDte->reception_stamp }}</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value highlight">$ {{ $originalDte->total_amount }} USD</span>
                </div>
            </div>
